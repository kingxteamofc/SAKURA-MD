...
let handler = async (m, { conn, text, usedPrefix, command, args, participants, isOwner }) => {
 ...
 if (e.length) await conn.reply(res, `*🎯 Hello Guys SAKURA MD Bot Here!
 ඔන්න සකුරා ආවා😅🌸 ${prefix}menu to get bot menu*

@94718392160 He Is My Creator If You Have Any Doubt
